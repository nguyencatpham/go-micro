// Package kubernetes taken from https://github.com/nguyencatpham/go-micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/nguyencatpham/go-micro/v3/util/log"
)
